...
class AppDelegate: UIResponder, UIApplicationDelegate {
  ...
  func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
    ...
    if firstLaunch{
      ...
      //sUserDefaults.standard.set(false, forKey: "FirstLaunch")
      ...
      let initialViewController = storyboard.instantiateViewController(withIdentifier: "Walkthrough") as! UINavigationController
